...
HI_S32 HI_SCENE_SetThreadDRC_AutoGenerate(VI_PIPE ViPipe, HI_U8 u8Index, HI_U32 u32ActRation, HI_U32 u32Iso)
{
    ...
    {
        u8LocalMixingBrightMax = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
                                                   g_astScenePipeParam[u8Index].stThreadDrc.au8LocalMixingBrightMax[u32IsoLevel],
                                                   g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel + 1],
    ...
    {
        u8LocalMixingBrightMin = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8LocalMixingDarkMax = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8LocalMixingDarkMin = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        s8DetailAdjustFactor = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8SpatialFltCoef = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8RangeFltCoef = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8GradRevMax = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8GradRevThr = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8Compress = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    {
        u8Stretch = SCENE_Interpulate(u32Iso,g_astScenePipeParam[u8Index].stThreadDrc.au32ISOLevel[u32IsoLevel],
    ...
    //stIspDrcAttr.enCurveSelect = DRC_CURVE_ASYMMETRY;
