...
#define SAMPLE_SVP_ROUND(value) (vx_float32)(((vx_float32)(value) > 0)? floor((vx_float32)(value)+0.5):ceil((vx_float32)(value)-0.5))
#define SAMPLE_SVP_FLOOR(value) ((vx_int32)((value) + ((value) >= 0 ? 0.5 : -0.5))) - ((vx_float32)((value)-(vx_int32)((value) + ((value) >= 0 ? 0.5 : -0.5))) < 0)
#define SAMPLE_SVP_CEIL(value)  ((vx_int32)((value) + ((value) >= 0 ? 0.5 : -0.5))) + ((vx_float32)((vx_int32)((value) + ((value) >= 0 ? 0.5 : -0.5))-(value)) < 0)
...
#define SAMPLE_SVP_FASTERRCNN_RPN_SCORE_NUM       2        /*the num of PRN scores*/
#define SAMPLE_SVP_PARAMETER_NUM_OF_STACK_ELEMENT 2        /*the parameter num of each stack element*/
#define SAMPLE_SVP_SAFE_ROUND(val) (double)(((double)(val) > 0)? floor((double)(val)+0.5):ceil((double)(val)-0.5))
#define SAMPLE_SVP_MAX_THREAD_NUM                 4       /*Roipooling max thread num,must be equal to sample_svp_roi_pooling_kernel.c's thread num */
