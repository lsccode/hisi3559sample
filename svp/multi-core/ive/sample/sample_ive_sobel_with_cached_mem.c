...
static HI_S32 SAMPLE_IVE_SobelProc(SAMPLE_IVE_SOBEL_S* pstSobel)
{
    ...
    memcpy((HI_VOID*)pstSobel->stSrc2.au64VirAddr[0], (HI_VOID*)pstSobel->stSrc1.au64VirAddr[0], pstSobel->stSrc2.au32Stride[0] * pstSobel->stSrc2.u32Height);
    s32Ret = HI_MPI_SYS_MmzFlushCache(pstSobel->stSrc1.au64PhyAddr[0], (HI_VOID*)pstSobel->stSrc1.au64VirAddr[0],
    ...
    {
        s32Ret = HI_MPI_SYS_MmzFlushCache(pstSobel->stSrc2.au64PhyAddr[0], (HI_VOID*)pstSobel->stSrc2.au64VirAddr[0],
