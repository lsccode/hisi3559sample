...
******************************************************************************/
HI_S32 SAMPLE_IVE_MsgProcess(HI_BOOL bVo, HI_BOOL bEncode,
    SAMPLE_IVE_DRAW_RECT_MSG_S *pstDrawRectMsg)
{
    ...
    pstReqMsg = HI_IPCMSG_CreateMessage(HI_ID_IVE, SAMPLE_MEDIA_CMD_IVE_DRAW_RECT_PROC,
                pstDrawRectMsg, sizeof(SAMPLE_IVE_DRAW_RECT_MSG_S));
    SAMPLE_CHECK_EXPR_RET(NULL == pstReqMsg,HI_FAILURE,"Error,HI_IPCMSG_CreateMessage failed!\n");
