...
static HI_S32 SAMPLE_IVE_Svm_CreateTable(IVE_LOOK_UP_TABLE_S* pstTable, HI_FLOAT fGamma)
{
    ...
    ps1q15Tmp = (HI_S1Q15*)pstTable->stTable.u64VirAddr;
...
static HI_S32 SAMPLE_IVE_Svm_Predict(SAMPLE_IVE_SVM_INFO_S* pstSvmInfo)
{
    ...
    {
        ps16q16Src = (HI_S16Q16 *)(pstSvmInfo->stSrc.u64VirAddr  + i * pstSvmInfo->stSrc.u32Stride);
        ...
        SAMPLE_IVE_Svm_Feature((HI_U8*)pstSvmInfo->stGrayImg.au64VirAddr[0], pstSvmInfo->stGrayImg.u32Width, \
    ...
    {
        pu16Vote = (HI_U16*)(pstSvmInfo->stVote.u64VirAddr + i * pstSvmInfo->stVote.u32Stride);
        u8MaxVoteIdx = 0;
