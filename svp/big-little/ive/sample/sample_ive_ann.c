...
static HI_S32 SAMPLE_IVE_Ann_Mlp_Predict(SAMPLE_IVE_ANN_INFO_S* pstAnnInfo)
{
    ...
    for (i = 0; i < pstAnnInfo->stSrc.u32Height; ++i)
    {
        ...
        ps16q16Src = (HI_S16Q16*)(pstAnnInfo->stSrc.u64VirAddr + pstAnnInfo->stSrc.u32Stride * i);
        ...
        SAMPLE_IVE_Ann_Mlp_BinFeature((HI_U8*)pstAnnInfo->stGray.au64VirAddr[0],\
    ...
    {
        ps16q16Dst = (HI_S16Q16*)(pstAnnInfo->stDst.u64VirAddr + pstAnnInfo->stDst.u32Stride * i);
        s16q16Response = 0;
        s32ResponseCls = -1;
