...
static HI_S32 SAMPLE_IVE_St_LkProc(SAMPLE_IVE_ST_LK_S* pstStLk)
{
    ...
    IVE_ST_CORNER_INFO_S* pstCornerInfo = (IVE_ST_CORNER_INFO_S*)pstStLk->stCorner.u64VirAddr;
    IVE_POINT_S25Q7_S *psts25q7NextPts = (IVE_POINT_S25Q7_S *) pstStLk->stNextPts.u64VirAddr;
    ...
    for (i = 0; i < u32FrameNum; i++)
    {
        ...
        else
        {
            ...
            for (k = 0; k < pstStLk->stLkPyrCtrl.u16PtsNum; k++)
            {
                if(! ((HI_U8*)pstStLk->stStatus.u64VirAddr)[k])
                {
                    continue;
                }
        ...
        memcpy((HI_VOID*)pstStLk->stPrevPts.u64VirAddr,(HI_VOID*)pstStLk->stNextPts.u64VirAddr,
