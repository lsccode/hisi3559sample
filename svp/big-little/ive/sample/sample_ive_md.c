...
static HI_VOID * SAMPLE_IVE_MdProc(HI_VOID * pArgs)
{
    ...
    while (HI_FALSE == s_bStopSignal)
    {
        ...
        SAMPLE_COMM_IVE_BlobToRect((IVE_CCBLOB_S *)pstMd->stBlob.u64VirAddr,&(pstMd->stRegion),IVE_RECT_NUM,8,
         ...
         memcpy(&stDrawRectMsg.stRegion, &pstMd->stRegion, sizeof(SAMPLE_RECT_ARRAY_S));
         s32Ret = SAMPLE_IVE_MsgProcess(HI_TRUE, HI_FALSE, &stDrawRectMsg);
         SAMPLE_CHECK_EXPR_GOTO(HI_SUCCESS!=s32Ret, BASE_RELEASE,
