...
extern HI_S32 MSG_VDEC_PROC(HI_S32 s32MsgId, HI_IPCMSG_MESSAGE_S *pstMsg);
...
static void Media_Server_Msg_Proc(HI_S32 s32Id, HI_IPCMSG_MESSAGE_S* stMsg)
{
    ...
    switch(u32ModID)
    {
        ...
        case SAMPLE_MOD_VENC:
            ...
            break;
        case SAMPLE_MOD_VDEC:
            MSG_VDEC_PROC(s32Id, stMsg);
            break;
        default:
...
printf("func:%s, line:%d\n", __FUNCTION__, __LINE__);
    ...
    pthread_attr_setstacksize(&pthAttr, 0x100000);
