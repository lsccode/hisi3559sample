...
******************************************************************************
  File Name     : es20_eglCreatePixmapSurface.c
...
int main(void)
{
    ...
    if (-1 == framebuffer_fd)
    {
        ...
        MALI_FPRINT("open framebuffer device failed\n");
        return 0;
    }
#endif
    ...
    egl_surface = eglCreatePixmapSurface(egl_display, egl_config, native_pixmap, NULL);
    ...
    {
        MALI_FPRINT("load texture datas failed\n");
    }
